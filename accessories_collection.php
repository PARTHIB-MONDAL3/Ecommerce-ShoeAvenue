<?php
    ...
    } elseif(isset($_GET['sort']) && $_GET['sort'] == 'sof') {
        $sortOrder = "AND brand='sof'";
    } elseif(isset($_GET['sort']) && $_GET['sort'] == 'adidas') {
        $sortOrder = "AND brand='Adidas'";
    } elseif(isset($_GET['sort']) && $_GET['sort'] == 'socks') {
        $sortOrder = "AND brand='socks'";
    } elseif(isset($_GET['sort']) && $_GET['sort'] == 'apara') {
        $sortOrder = "AND brand='apara'";
    }elseif(isset($_GET['sort']) && $_GET['sort'] == 'sole') {
        $sortOrder = "AND brand='sole'";
...
<body>
    <header class="header1">
        <div >
            ...
            <img class="image3 logo" id="home" src="imgs/logo.png" alt="alt text" />
        </div>
        <div class="topnav">
        ...
        <div style="width: 70%; display:flex; gap: 20px">
            ...
            <div class="dropdown">
                ...
                <div class="content">
                    ...
                    <a href="?sort=sof">SOF</a>
                    <a href="?sort=socks">Socks</a>
                    <a href="?sort=apara">APARA</a>
                    <a href="?sort=sole">SOLE</a>
                </div>
            </div>
        </div>
    ...
    <footer class="footer" id="footer" style="top: 3000px;">
        <div>
            <img class="image3 logo1" src="./assets2/footprint_brand_logo_blue.jpg" alt="alt text" />
            <div class="soc"> 
        ...
        <div class="info">
            ...
            <a href="index.php#aboutus"><span >About ShoeAvenue</span></a>
        ...
        <div class="copy">
            <a href=""><h5>© 2024 ShoeAvenue, Inc.</h5></a>
        </div>
