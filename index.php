...
<body>
    <header class="header">
        <div >
            ...
            <img class="image3 logo" id="home" src="./assets2/footprint_brand_logo.png" alt="alt text" />
        </div>
        <div class="topnav">
    ...
    <div class="aboutus" id="aboutus">
        ...
        <h3 class="subhero">
            At ShoeAvenue, we believe that shoes are more than just functional footwear - they&#x27;re a powerful
            expression of personal style and confidence. Founded in 2024 by a team of passionate shoe enthusiasts,
            ...
            comfort and support. Our in-house fit experts are dedicated to helping you find your perfect match.<br />ShoeAvenue
    ...
    <footer class="footer" id="footer">
        ...
        <div class="info">
            ...
            <a href="#aboutus"><span >About ShoeAvenue</span></a>
